...
import downloadLink from "../../../../Download/currículo2.pdf";
import "../../../../App.css"
            ...
            <Grid item xs={12} md={7}>
              ...
              >
                ...
                >
                  <StyledButton>
                    <ArrowDownwardIcon />
                    <Typography><a href={downloadLink} download='currículo2.pdf' style={{ textDecoration: 'none', color: 'inherit' }}>Download CV</a></Typography>
                  </StyledButton>
                </Grid>
                <Grid
                  item
